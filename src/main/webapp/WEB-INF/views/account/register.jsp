	...
	<form id="inputForm" action="${ctx}/register" method="post" class="form-horizontal">
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="hidden"  name="roles[0].id" class="input-large" value="4" />
					<input type="text" id="userType" name="roles[0].name" class="input-large required" />
					<!-- <select>
						<option name="userType" value="-1">--请选择--</option>
						<option name="userType" value="trader">交易员</option>
						<option name="userType" value="businessman">交易商</option>
					</select> -->
				</div>
			</div>
